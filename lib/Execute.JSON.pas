...
type
  ...
  public
    procedure AppendString(const Str: TString; Nullable: Boolean = True);
...
begin
  ...
  case TypeInfo.ExtendedType of
    ...
    etUTF8String: Result := jsUTF8String;
...
begin
  ...
  Len := Base64LenW(@FText[Start], FIndex - Start - 1);
  SetLength(Bytes, Len);
  Base64DecodeW(@FText[Start], PByte(Bytes), Len);
end;
...
begin
  b.AsBoolean := True;
  Assert(b.AsBoolean and b.IsSet);
  b.AsBoolean := False;
  Assert(b.AsBoolean = False and b.IsSet);
  b.AsBoolean := True;
  b.Clear;
  Assert((b.AsBoolean = False) and (b.IsSet = False));
end;
